...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Shooter_EAmmoType_Hash() { return 2816990551U; }
	UEnum* Z_Construct_UEnum_Shooter_EAmmoType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EAmmoType::EAT_NAX", (int64)EAmmoType::EAT_NAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "EAT_NAX.DisplayName", "DefaultMAX" },
				{ "EAT_NAX.Name", "EAmmoType::EAT_NAX" },
	...
	IMPLEMENT_CLASS(AShooterCharacter, 195084622);
