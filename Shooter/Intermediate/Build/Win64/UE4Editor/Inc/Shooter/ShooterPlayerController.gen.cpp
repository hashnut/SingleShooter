...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AShooterPlayerController_Statics::NewProp_HUDOverlay_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Widgets" },
		{ "Comment", "/* Variable to hold the HUD Overlay idget after creating it */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "ShooterPlayerController.h" },
		{ "ToolTip", "Variable to hold the HUD Overlay idget after creating it" },
	};
#endif
	...
	IMPLEMENT_CLASS(AShooterPlayerController, 1237838772);
